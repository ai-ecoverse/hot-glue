...
describe.skipIf(!runtime)('expand.hma — the expander', () => {
  ...
  it('expands its own source to the text it is running as', () => {
    const source = src('src/expand.hma');
